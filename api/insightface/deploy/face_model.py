...
# sys.path.append(os.path.join(ROOT_DIR, 'insightface', 'deploy'))
sys.path.append(os.path.join(ROOT_DIR, 'insightface', 'src', 'common'))
# import face_image
# import face_preprocess
from api.insightface.src.common import face_preprocess, face_image
